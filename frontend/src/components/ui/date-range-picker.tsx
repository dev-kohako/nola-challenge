...
export function DateRangePicker({ value, onChange }: DateRangePickerProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent
        className={cn(
          "p-0 sm:max-w-[720px] bg-background border border-border shadow-2xl rounded-2xl overflow-hidden",
          "flex flex-col"
        )}
      ...
      >
        ...
        <footer className="flex justify-end sm:justify-between gap-3 p-4 border-t border-border bg-muted/20">
          <Button
            variant="outline"
            onClick={handleClear}
